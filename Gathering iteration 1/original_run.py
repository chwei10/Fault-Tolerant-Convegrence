...
def parse_arguments():
    ...
    parser.add_argument('--observation_radius', type=float, default=40, help='The visibility range of the robots')
...
def main():
    ...
    for i in range(args.num_robots):
        ...
        robot = Robot(id=i, observation_radius=args.observation_radius, speed=args.speed,
                      x=x, y=y, terminate=False, trajectory_x=[x], trajectory_y=[y])
